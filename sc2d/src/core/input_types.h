//
// Created by novasurfer on 4/26/20.
//

#ifndef SCARECROW2D_INPUT_TYPES_H
#define SCARECROW2D_INPUT_TYPES_H
...
struct Key
{
    enum Code
    {
        ...
        GRAVE_ACENT = GLFW_KEY_GRAVE_ACCENT,
...
#endif //SCARECROW2D_INPUT_TYPES_H
