...
namespace math {
    ...
    struct mat4 {
        ...
        float determinant() const
        {
            ...
            n[0][3] * n[0][0] * n[1][1] * n[3][2] -
            n[0][3] * n[0][0] * n[1][2] * n[3][1] -
            n[0][3] * n[0][1] * n[1][0] * n[3][2] +
            n[0][3] * n[0][1] * n[1][2] * n[3][0] +
            n[0][3] * n[0][2] * n[1][0] * n[3][1] -
            n[0][3] * n[0][2] * n[1][1] * n[3][0] ;
        }
        ...
        {               // M (0,0)
            return mat4(n[1][1] * n[2][2] * n[3][3] + n[1][2] * n[2][3] * n[3][1] +
                        ...
                        // M (0,2)
                        n[1][1] * n[2][1] * n[3][3] + n[1][1] * n[2][3] * n[3][0] +
                        ...
                        n[0][2] * n[2][0] * n[3][2] - n[0][0] * n[2][2] * n[3][1] ,
                        // --------------------------------------------------------
                        // M (2,0)
                        n[0][1] * n[1][2] * n[3][3] + n[0][2] * n[1][3] * n[3][1] +
                        n[0][3] * n[1][1] * n[3][2] - n[0][3] * n[1][2] * n[3][0] -
