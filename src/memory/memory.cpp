...
namespace sc2d::memory
{
    namespace main
    {
        ...
        void init()
        {
            ...
            _main_allocator = new(_buffer)
                free_list_allocator(_memory_size - sizeof(free_list_allocator),
                                    reinterpret_cast<void*>(reinterpret_cast<uintptr_t>(_buffer) +
                                                            sizeof(free_list_allocator)));
        }
